    ...
    <div className="App">
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/alumno/datosPersonales/:id" element={<DatosPersonales />} />
          <Route path="/profesor/datosPersonalesProf/:id" element={<DatosPersonales />} />
          <Route
            path="/alumno/MateriasReprobadas/:id"
