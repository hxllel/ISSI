...
export function ChatbotAsistente() {
  ...
  const handleEvaluacion = () => {navigate(`/alumno/evaluacion/${alumnoId}`);};
    const handleEditPer = () => {navigate(`/alumno/datosPersonales/${alumnoId}`);};
  const handleETS = () => {navigate(`/alumno/MateriasReprobadas/${alumnoId}`);};
  ...
  return (
    <div className="chatbot-container">
      ...
      <aside className="sidebar">
        ...
        <nav className="menu">
          <button onClick={() => navigate(`/alumno/${alumnoId}`)} className="menu-item ">
            Inicio
          </button>
