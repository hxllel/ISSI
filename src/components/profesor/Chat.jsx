  ...
  return (
    <div className="chatbot-container">
      ...
      <aside className="sidebar">
        ...
        <nav className="menu">
          <Link to={`/profesor/${id}`} className={`menu-item ${!isClases ? "inactive" : ""}`}>Inicio</Link>
          ...
          <button className="menu-item active" onClick={() => navigate(`/profesor/chat`)}>Asistente de Chat</button>
          <button className="menu-item" onClick={() => navigate(`/profesor/${id}/perfil`)}>Información Personal</button>
