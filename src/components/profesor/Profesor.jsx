  ...
  return (
    <div className="admin-container">
      ...
      <aside className="sidebar">
        ...
        <nav className="menu">
          <Link to={`/profesor/${id}`} className={`menu-item ${!isClases ? "active" : ""}`}>Inicio</Link>
          <Link to={`/profesor/${id}/clases`} className={`menu-item ${isClases ? "active" : ""}`}>Clases Impartidas</Link>
          <button className="menu-item" onClick={() => navigate(`/profesor/${id}/grupos`)}>Horario</button>  
          <button className="menu-item" onClick={() => navigate(`/profesor/chat`)}>Asistente de Chat</button>
          <button className="menu-item" onClick={() => navigate(`/profesor/datosPersonalesProf/${id}`)}>Información Personal</button>
          <button className="menu-item" onClick={() => navigate(`/profesor/${id}/calificaciones`)}>Calificaciones</button>
        </nav>
